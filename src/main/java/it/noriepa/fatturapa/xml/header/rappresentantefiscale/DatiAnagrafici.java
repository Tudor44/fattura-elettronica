...
import it.noriepa.fatturapa.jaxb.DatiAnagraficiRappresentanteType;
...
public class DatiAnagrafici {
    ...
    public DatiAnagraficiRappresentanteType creaDatiAnagraficiRappresentante(){
        DatiAnagraficiRappresentanteType datiAnagraficiRappresentanteType = new DatiAnagraficiRappresentanteType();
        datiAnagraficiRappresentanteType.setIdFiscaleIVA(idFiscaleIVA.creaIdFiscaleIVA());
        datiAnagraficiRappresentanteType.setAnagrafica(anagrafica.creaAnagrafica());
        if(Optional.ofNullable(codiceFiscale).isPresent()) {
            datiAnagraficiRappresentanteType.setCodiceFiscale(codiceFiscale.get());
        }
        return datiAnagraficiRappresentanteType;
