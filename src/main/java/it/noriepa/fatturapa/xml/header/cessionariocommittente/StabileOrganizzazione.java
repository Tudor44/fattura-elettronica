...
public class StabileOrganizzazione {
    ...
    public StabileOrganizzazione(String indirizzo, String cap, String comune, String nazione) {
    ...
    public StabileOrganizzazione(String indirizzo, Optional<String> numeroCivico, String cap, String comune, Optional<String> provincia, String nazione) {
        this.indirizzo = indirizzo;
    ...
    public IndirizzoType creaStabileOrganizzazione(){
