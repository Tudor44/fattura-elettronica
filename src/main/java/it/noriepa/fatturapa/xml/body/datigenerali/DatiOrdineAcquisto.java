...
public class DatiOrdineAcquisto {
    ...
    public DatiOrdineAcquisto(Optional<List<Integer>> riferimentoNumeroLinea, String idDocumento, Optional<XMLGregorianCalendar> data, Optional<String> numItem, Optional<String> codiceCommessaConvenzione, Optional<String> codiceCUP, Optional<String> codiceCIG) {
    ...
    public DatiOrdineAcquisto(String idDocumento) {
        this.idDocumento = idDocumento;
    }
    ...
    public DatiDocumentiCorrelatiType creaDatiOrdineAcquisto(){
