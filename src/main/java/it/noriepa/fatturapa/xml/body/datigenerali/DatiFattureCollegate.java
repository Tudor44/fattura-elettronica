...
public class DatiFattureCollegate {
    ...
    public DatiFattureCollegate(Optional<List<Integer>> riferimentoNumeroLinea, String idDocumento, Optional<XMLGregorianCalendar> data, Optional<String> numItem, Optional<String> codiceCommessaConvenzione, Optional<String> codiceCUP, Optional<String> codiceCIG) {
    ...
    public DatiFattureCollegate(String idDocumento) {
        this.idDocumento = idDocumento;
    }
    ...
    public DatiDocumentiCorrelatiType creaDatiFattureCollegate(){
