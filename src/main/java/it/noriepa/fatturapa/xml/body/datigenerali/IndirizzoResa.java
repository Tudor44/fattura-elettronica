...
public class IndirizzoResa {
    ...
    public IndirizzoResa(String indirizzo, String cap, String comune, String nazione) {
    ...
    public IndirizzoResa(String indirizzo, Optional<String> numeroCivico, String cap, String comune, Optional<String> provincia, String nazione) {
        this.indirizzo = indirizzo;
    ...
    public IndirizzoType creaIndirizzoResa(){
