...
public class DatiRicezione {
    ...
    public DatiRicezione(Optional<List<Integer>> riferimentoNumeroLinea, String idDocumento, Optional<XMLGregorianCalendar> data, Optional<String> numItem, Optional<String> codiceCommessaConvenzione, Optional<String> codiceCUP, Optional<String> codiceCIG) {
    ...
    public DatiRicezione(String idDocumento) {
        this.idDocumento = idDocumento;
    }
    ...
    public DatiDocumentiCorrelatiType creaDatiRicezione(){
