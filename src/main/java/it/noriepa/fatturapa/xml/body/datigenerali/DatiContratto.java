...
public class DatiContratto {
    ...
    public DatiContratto(Optional<List<Integer>> riferimentoNumeroLinea, String idDocumento, Optional<XMLGregorianCalendar> data, Optional<String> numItem, Optional<String> codiceCommessaConvenzione, Optional<String> codiceCUP, Optional<String> codiceCIG) {
    ...
    public DatiContratto(String idDocumento) {
        this.idDocumento = idDocumento;
    }
    ...
    public DatiDocumentiCorrelatiType creaDatiContratto(){
